...
<body>
							...
							<table class="table table-borderless text-start">
								<tbody>
									...
									<tr>
										...
										<td style="font-size: 14px;">{{store.title}}</td>
									</tr>
									<tr>
					...
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="d-flex justify-content-center gap-2 flex-wrap" v-show="store.isTime">
								<span class="btn btn-xs btn-success" v-for="(t, i) in store.time_list" :key="i" style="margin: 2px;" @click="store.timeSelect(t)">
									{{t}}
								</span>
							</div>
						</div>
					...
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="d-flex justify-content-center gap-2 flex-wrap" v-if="store.isInwon">
								<span class="btn btn-xs btn-warning" v-for="(t, i) in store.inwon_list" :key="i" style="margin: 2px;" @click="store.inwonSelect(t)">
									{{t}}
								</span>
							</div>
						</div>
	...
	<script>
		...
		const {onMounted, createApp, ref, watch} = Vue
