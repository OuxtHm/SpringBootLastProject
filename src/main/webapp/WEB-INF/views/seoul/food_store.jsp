            ...
            <div class="row">
                <table class="table">
                    <tbody>
                        ...
                        <tr><td width="15%" class="text-center">안내</td><td width="55%">${vo.fsvo.infocenter }</td></tr>
                        <tr><td width="15%" class="text-center">영업시간</td><td width="55%">${vo.fsvo.opentime }</td></tr>
                        <tr><td width="15%" class="text-center">휴무일</td><td width="55%">${vo.fsvo.restdate }</td></tr>
                        <tr><td width="15%" class="text-center">주차</td><td width="55%">${vo.fsvo.parking }</td></tr>
                        <tr><td width="15%" class="text-center">주메뉴</td><td width="55%">${vo.fsvo.firstmenu }</td></tr>
                        <tr><td width="15%" class="text-center">부메뉴</td><td width="55%">${vo.fsvo.treatmenu }</td></tr>
                    </tbody>
                </table>

                <table class="table">
                    <tbody>
                        <tr><td>${vo.fsvo.msg }</td></tr>
                        <tr>
                            <td class="text-right">
                                        ...
                                        <div class="option">
                                            <div>
                                                <form onsubmit="searchPlaces(); return false;">
                                                    키워드 : <input type="text" value="${vo.address } 맛집" id="keyword" size="15">
                ...
                <div id="comment" style="width: 100%">
                                ...
                                <div class="comment-wrapper d-flex" v-if="rvo.group_tab===0">
                                    ...
                                    <div class="comment-content">
                                        ...
                                        <div class="comment-form" style="padding-top: 5px" v-if="store.upReplyNo===rvo.no">
                                            <textarea v-model="store.updateMsg[rvo.no]" cols="50" rows="5" style="float: left;"></textarea>
                                            <button type="button" class="btn-primary" style="float: left; width: 80px; height: 100px;" @click="store.replyUpdate(rvo.no)">수정</button>
                                        </div>
                                        <div class="comment-form" style="padding-top: 5px" v-if="store.reReplyNo===rvo.no">
                                            <textarea v-model="store.replyMsg[rvo.no]" cols="50" rows="5" style="float: left;"></textarea>
                                            <button type="button" class="btn-primary" style="float: left; width: 80px; height: 100px;" @click="store.replyReply(rvo.no)">댓글</button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="leave-comment-area section_padding_50 clearfix" v-if="store.sessionId!==''">
                        <div class="comment-form">
                            <textarea ref="msgRef" v-model="store.msg" cols="80" rows="5" placeholder="댓글을 입력하세요" style="float: left;"></textarea>
                            <button type="button" class="btn-primary" style="float: left; width: 80px; height: 100px;" @click="store.commonsInsert(msgRef)">댓글쓰기</button>
                        </div>
                    </div>
