	            ...
	            <div class="row">
	                <div class="col-12">
	                    <nav aria-label="breadcrumb">
	                        <ol class="breadcrumb">
	                            <input type=text size=20 class="input-sm" v-model="store.address" ref="addressRef" @keydown.enter="store.find(addressRef)">
	                        ...
	                        <nav aria-label="#">
	                            <ul class="pagination">
	                            	<li class="page-item" v-if="store.startPage > 1">
	                                    <a class="page-link" @click="store.movePage(store.startPage-1)"><i class="fa fa-angle-double-left" aria-hidden="true"> 이전</i></a>
	                                </li>
