					...
					<tbody>
						...
						<tr>
							<td class="text-center" colspan="5">
								<a href="/board/list?page=${curpage>1?curpage-1:curpage }" class="btn btn-sm btn-warning">&lt;</a>
									${curpage } page / ${totalPage } pages
								<a href="/board/list?page=${curpage<totalPage?curpage+1:curpage }" class="btn btn-sm btn-warning">&gt;</a>
							</td>
						</tr>
					</tbody>
				</table>
