			...
			<thead>
				...
				<tr v-for="(vo,i) in store.reserve_list" :key="i">
					...
					<td class="text-center">
						<button class="btn-xs btn-info" v-if="isReserve===0">예약대기</button>
						<button class="btn-xs btn-info" v-else @click="store.reserveDetail(vo.no)">예약완료</button>
						<button class="btn-xs btn-warning" style="margin-left: 2px" @click="store.reserveRequest(vo.no)" v-if="vo.iscancel===0">취소요청</button>
						<span class="btn-xs btn-default" style="margin-left: 2px" v-else>취소대기</span>
					</td>
				</tr>
			</thead>
		</table>
				...
				<tbody>
					...
					<tr>
						<td width="30%" class="text-center" rowspan="8">
							<img :src="store.reserve_detail.svo.image1" style="width: 100%; height: 320px">
						</td>
